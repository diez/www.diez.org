<template>
  <div class="page shared">
    ...
    <section id="licensing" class="section section-narrow">
      ...
      <p>Diez is published under a dual-license model in two editions: <strong>Community Edition</strong> and <strong>Commercial License</strong>.</p>
      ...
      <ul>
        ...
        <li>Git — the world’s most popular version-control command-line tool, GPL-licensed</li>
        <li>MongoDB — the world’s most popular NoSQL database server, formerly AGPL licensed, currently SSPL licensed</li>
      ...
      <p>If you are not willing or able to meet these requirements of the AGPL license, you will want Diez Commercial License instead, which offers flexible commercial licensing. Reach out to <a href="mailto:contact@diez.org" target="_blank">contact@diez.org</a> to learn more.</p>
      ...
      <p>If you are not willing or able to meet these requirements of the LGPL license, you will want Diez Commercial License instead, which offers flexible commercial licensing. Reach out to <a href="mailto:contact@diez.org" target="_blank">contact@diez.org</a> to learn more.</p>
      <h3>Diez Commercial License</h3>
      ...
      <p>Additionally, <strong>Diez Commercial License</strong> offers two Enterprise-focused advantages over Diez Community Edition:</p>
      <ul>
      ...
      <p>Reach out to <a href="mailto:contact@diez.org" target="_blank">contact@diez.org</a> to learn more.</p>
    </section>
    <Footer/>
  </div>
</template>
